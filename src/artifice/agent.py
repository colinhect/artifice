"""Simple AI agent connector for Claude and other LLMs."""
...
class ClaudeAgent(AgentBase):
    ...
    def __init__(
        ...
        Args:
            ...
            on_tool_call: Optional callback when a tool completes (for UI updates).
            on_tool_start: Optional callback when a tool starts (for UI updates).
            ...
            for iteration in range(max_iterations):
                ...
                for tool_use in tool_uses:
                    ...
                    if self.on_tool_start:
                        result = self.on_tool_start(tool_use["name"], tool_use["input"])
                    ...
                    # Notify UI about tool call completion (after execution, so we have results)
...
def create_agent(agent_type: str = "claude", **kwargs) -> AgentBase:
    ...
    if agent_type == "claude":
        ...
        raise ValueError(f"Unknown agent type: {agent_type}. Use 'claude' or 'copilot'.")
